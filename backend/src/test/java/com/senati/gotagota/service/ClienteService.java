...
// Importamos la anotación @service
//Esto es la capa de la logica de negocio, aqui van la validaciones, calculos, etc.
@Service
public class ClienteService {
    ...
    //Retornar a recive la lista de todos los clientes
